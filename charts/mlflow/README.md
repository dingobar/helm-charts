...
![Version: 1.0.4](https://img.shields.io/badge/Version-1.0.4-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.15.2](https://img.shields.io/badge/AppVersion-1.15.2-informational?style=flat-square)
...
| Name | Email | Url |
| ---- | ------ | --- |
| dingobar |  | https://github.com/dingobar/ |
...
| tolerations | list | `[]` |  |
| useProbes | bool | `true` | whether to use readiness and liveness probes |
